...
function M.migrate()
  ...
  if not json.data.version then
    ...
    json.data.extras = vim.tbl_map(function(extra)
      return "neoverse.extras." .. extra
    end, json.data.extras or {})
  elseif json.data.version == 1 then
    json.data.extras = vim.tbl_map(function(extra)
      -- replace double extras module name
      return extra:gsub("^neoverse%.extras%.neoverse%.extras%.", "neoverse.extras.")
    end, json.data.extras or {})
  elseif json.data.version == 2 then
    json.data.extras = vim.tbl_map(function(extra)
      return extra == "neoverse.extras.editor.symbols-outline" and "neoverse.extras.editor.outline"
        or extra
    end, json.data.extras or {})
  end
