...
Utils.map("t", [[<c-\>]], "<cmd>fclose<cr>", { desc = "floating terminal » close [pwd]" })
Utils.map("n", [[<c-\>]], function() ft(nil) end, { desc = "floating terminal » open [pwd]" })
Utils.map("n", "<leader>fT", function() ft(nil) end, { desc = "floating terminal » open [pwd]" })
